...
<div class="navbar-header">
    ...
    <a class="navbar-brand" href="index.php">Clocking Web App Portal</a>
</div>
<!-- /.navbar-header -->
...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <?php
            //Left menu links
            $links = json_decode(file_get_contents("../include/leftmenulinks.json"), true);
